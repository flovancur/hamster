...
namespace HamsterIoHTests
{
    ...
    public class PunishTests : MqttTestBase
    {
        ...
        public void Punish_CausesLogInClient(int amount)
        {
            ...
            Assert.That(waitForLog.Result, Is.EqualTo($"> {amount} punishments received for Hamster {HamsterId}"));
        }
        ...
        public void Punish_MultiplePunishments_AllPublished()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                StringAssert.EndsWith($"{1} punishments received for Hamster {HamsterId}", waitForLog.Result);
            }
        }
    }
}
